...
#
# Created: Thu Jul 31 13:18:06 2008
...
class Ui_RecCpfv(object):
    def setupUi(self, RecCpfv):
        ...
        RecCpfv.resize(QtCore.QSize(QtCore.QRect(0,0,938,598).size()).expandedTo(RecCpfv.minimumSizeHint()))
        ...
        self.cpfv_name_line.setMinimumSize(QtCore.QSize(50,0))
        self.cpfv_name_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.cpfv_name_line.setFont(font)
        self.cpfv_name_line.setObjectName("cpfv_name_line")
        self.hboxlayout10.addWidget(self.cpfv_name_line)
        ...
        self.hboxlayout16.addWidget(self.cpfv_num_pass_line)
        ...
        self.hboxlayout17.addWidget(self.cpfv_num_out_state_line)
        ...
        self.hboxlayout20.addWidget(self.label_2)
        ...
        self.hboxlayout20.addWidget(self.cpfv_strat_tuna)
        self.vboxlayout7.addLayout(self.hboxlayout20)
        ...
        self.hboxlayout21.addWidget(self.label_3)

        self.cpfv_strat_coast = QtGui.QLineEdit(self.groupBox_2)
        self.cpfv_strat_coast.setEnabled(True)
        self.cpfv_strat_coast.setMinimumSize(QtCore.QSize(50,0))
        self.cpfv_strat_coast.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(9)
        self.cpfv_strat_coast.setFont(font)
        self.cpfv_strat_coast.setObjectName("cpfv_strat_coast")
        self.hboxlayout21.addWidget(self.cpfv_strat_coast)
        ...
        self.hboxlayout22.addWidget(self.label_5)
        ...
        self.hboxlayout22.addWidget(self.cpfv_strat_island)
        self.vboxlayout7.addLayout(self.hboxlayout22)
        self.hboxlayout19.addLayout(self.vboxlayout7)
        ...
        self.hboxlayout23.addWidget(self.label_4)

        self.cpfv_strat_rock = QtGui.QLineEdit(self.groupBox_2)
        self.cpfv_strat_rock.setEnabled(True)
        self.cpfv_strat_rock.setMinimumSize(QtCore.QSize(50,0))
        self.cpfv_strat_rock.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(9)
        self.cpfv_strat_rock.setFont(font)
        self.cpfv_strat_rock.setObjectName("cpfv_strat_rock")
        self.hboxlayout23.addWidget(self.cpfv_strat_rock)
        self.vboxlayout8.addLayout(self.hboxlayout23)
        ...
        self.hboxlayout24.addWidget(self.label_6)
        ...
        self.hboxlayout24.addWidget(self.cpfv_strat_misc)
        self.vboxlayout8.addLayout(self.hboxlayout24)

        spacerItem21 = QtGui.QSpacerItem(20,40,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.vboxlayout8.addItem(spacerItem21)
        self.hboxlayout19.addLayout(self.vboxlayout8)
        ...
        self.vboxlayout9 = QtGui.QVBoxLayout(self.groupBox_3)
        ...
        self.vboxlayout9.addWidget(self.label_12)
        ...
        self.hboxlayout26.addWidget(self.label_7)
        ...
        self.hboxlayout26.addWidget(self.cpfv_target_barracuda)
        self.vboxlayout10.addLayout(self.hboxlayout26)
        ...
        self.hboxlayout27.addWidget(self.label_8)
        ...
        self.hboxlayout27.addWidget(self.cpfv_target_bonito)
        ...
        self.hboxlayout28.addWidget(self.label_9)
        ...
        self.hboxlayout28.addWidget(self.cpfv_target_calico)
        ...
        self.hboxlayout29.addWidget(self.label_10)
        ...
        self.hboxlayout29.addWidget(self.cpfv_target_humboldt)
        ...
        self.hboxlayout30.addWidget(self.label_11)
        ...
        self.hboxlayout30.addWidget(self.cpfv_target_halibut)
        ...
        self.hboxlayout31.addWidget(self.cpfv_target_lingcod)
        ...
        self.hboxlayout32.addWidget(self.label_16)

        self.cpfv_target_rockfish = QtGui.QLineEdit(self.groupBox_3)
        self.cpfv_target_rockfish.setEnabled(True)
        self.cpfv_target_rockfish.setMinimumSize(QtCore.QSize(30,0))
        self.cpfv_target_rockfish.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(8)
        self.cpfv_target_rockfish.setFont(font)
        self.cpfv_target_rockfish.setObjectName("cpfv_target_rockfish")
        self.hboxlayout32.addWidget(self.cpfv_target_rockfish)
        self.vboxlayout10.addLayout(self.hboxlayout32)
        ...
        self.hboxlayout33.addWidget(self.label_17)
        ...
        self.hboxlayout33.addWidget(self.cpfv_target_sand)
        self.vboxlayout10.addLayout(self.hboxlayout33)
        self.hboxlayout25.addLayout(self.vboxlayout10)
        ...
        self.hboxlayout34.addWidget(self.cpfv_strat_sculpin_label)
        ...
        self.hboxlayout34.addWidget(self.cpfv_target_sculpin)
        self.vboxlayout11.addLayout(self.hboxlayout34)
        ...
        self.hboxlayout35.addWidget(self.cpfv_strat_white_abel)
        ...
        self.hboxlayout35.addWidget(self.cpfv_target_white)
        self.vboxlayout11.addLayout(self.hboxlayout35)
        ...
        self.hboxlayout36.addWidget(self.label_19)
        ...
        self.hboxlayout36.addWidget(self.cpfv_target_yellowtail)
        self.vboxlayout11.addLayout(self.hboxlayout36)
        ...
        self.hboxlayout37.addWidget(self.label_21)
        ...
        self.hboxlayout37.addWidget(self.cpfv_target_sheephead)
        self.vboxlayout11.addLayout(self.hboxlayout37)
        ...
        self.hboxlayout38.addWidget(self.label_24)
        ...
        self.hboxlayout38.addWidget(self.cpfv_target_shark)
        self.vboxlayout11.addLayout(self.hboxlayout38)
        ...
        self.hboxlayout39.addWidget(self.label_26)
        ...
        self.hboxlayout39.addWidget(self.cpfv_target_salmon)
        self.vboxlayout11.addLayout(self.hboxlayout39)
        ...
        self.hboxlayout40.addWidget(self.label_23)
        ...
        self.hboxlayout40.addWidget(self.cpfv_target_tuna)
        self.vboxlayout11.addLayout(self.hboxlayout40)
        ...
        self.hboxlayout41.addWidget(self.label_25)
        ...
        self.hboxlayout41.addWidget(self.cpfv_target_whitefish)
        self.vboxlayout11.addLayout(self.hboxlayout41)
        self.hboxlayout25.addLayout(self.vboxlayout11)
        ...
        self.hboxlayout42 = QtGui.QHBoxLayout(self.button_box)
        self.hboxlayout42.setSpacing(2)
        self.hboxlayout42.setMargin(2)
        ...
        self.hboxlayout42.addItem(spacerItem22)
        ...
        self.hboxlayout42.addWidget(self.pbnCancel)
        ...
        self.hboxlayout42.addWidget(self.pbnFinished)
    ...
    def retranslateUi(self, RecCpfv):
        ...
        self.label.setText(QtGui.QApplication.translate("RecCpfv", "Assuming there are five (5) major fishing strategies, what percentage of your trips (annually) are associated with each strategy?", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("RecCpfv", "Offshore Tuna", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_strat_tuna.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("RecCpfv", "Coastal Freelance", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_strat_coast.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("RecCpfv", "Island Freelance", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_strat_island.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("RecCpfv", "Rockfish", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_strat_rock.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("RecCpfv", "Misc.", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_strat_misc.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_3.setTitle(QtGui.QApplication.translate("RecCpfv", "Targeted Species:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setText(QtGui.QApplication.translate("RecCpfv", "What percentage of your trips (annually) are associated with each species?", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("RecCpfv", "Barracuda:", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_barracuda.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("RecCpfv", "Bonito", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_bonito.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_9.setText(QtGui.QApplication.translate("RecCpfv", "Calico Bass", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_calico.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("RecCpfv", "Humboldt Squid", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_humboldt.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setText(QtGui.QApplication.translate("RecCpfv", "Halibut", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_halibut.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_18.setText(QtGui.QApplication.translate("RecCpfv", "Lingcod", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_lingcod.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_16.setText(QtGui.QApplication.translate("RecCpfv", "Rockfish", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_rockfish.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_17.setText(QtGui.QApplication.translate("RecCpfv", "Sand Bass", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_sand.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cpfv_target_sculpin.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cpfv_target_white.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_19.setText(QtGui.QApplication.translate("RecCpfv", "Yellowtail", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_yellowtail.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_21.setText(QtGui.QApplication.translate("RecCpfv", "Sheephead", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_sheephead.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_24.setText(QtGui.QApplication.translate("RecCpfv", "Thresher/Mako/Blue Shark", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_shark.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_26.setText(QtGui.QApplication.translate("RecCpfv", "Salmon", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_salmon.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_23.setText(QtGui.QApplication.translate("RecCpfv", "Tuna & Dorado", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_tuna.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
        self.label_25.setText(QtGui.QApplication.translate("RecCpfv", "Whitefish", None, QtGui.QApplication.UnicodeUTF8))
        self.cpfv_target_whitefish.setText(QtGui.QApplication.translate("RecCpfv", "0", None, QtGui.QApplication.UnicodeUTF8))
