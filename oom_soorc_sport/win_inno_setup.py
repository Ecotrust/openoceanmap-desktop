...
class InnoScript:
    ...
    def create(self, pathname="dist\\OpenOceanMap.iss"):
        ...
        print >> ofi, r"VersionInfoDescription=OpenOceanMap SOORC Sport Boat"
        print >> ofi, r"VersionInfoCopyright=Ecotrust"
        print >> ofi, r"AppCopyright=Ecotrust"
        print >> ofi, r"InfoAfterFile=U:\dev\openocean\branches\openoceanmap\oom_soorc_sport\README.TXT"
        print >> ofi, r"LicenseFile=U:\dev\openocean\branches\openoceanmap\oom_soorc_sport\LICENSE.TXT"
        print >> ofi, r"WizardImageBackColor=clBlack"
        print >> ofi, r"WizardImageFile=U:\dev\openocean\branches\openoceanmap\oom_soorc_sport\Images\OCEAN_VERT_INNO.bmp"
        print >> ofi, r"WizardSmallImageFile=U:\dev\openocean\branches\openoceanmap\oom_soorc_sport\Images\OCEAN_SMALL_INNO.bmp"
        print >> ofi, r"SetupIconFile=U:\dev\openocean\branches\openoceanmap\oom_soorc_sport\Images\OCEAN_SMALL_INNO.ico"
        print >> ofi
...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("OpenOceanMap SOORC Sport Boat",
                            lib_dir,
                            dist_dir,
