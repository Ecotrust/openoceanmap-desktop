...
class InnoScript:
    ...
    def create(self, pathname="dist\\OpenOceanMap.iss"):
        ...
        print >> ofi, r"VersionInfoDescription=OpenOceanMap MLPA NC CPFV"
        print >> ofi, r"VersionInfoCopyright=Ecotrust"
        print >> ofi, r"AppCopyright=Ecotrust"
        print >> ofi, r"InfoAfterFile=U:\dev\openocean\branches\openoceanmap\oom_norcal_charter\README.TXT"
        print >> ofi, r"LicenseFile=U:\dev\openocean\branches\openoceanmap\oom_norcal_charter\LICENSE.TXT"
        print >> ofi, r"WizardImageBackColor=clBlack"
        print >> ofi, r"WizardImageFile=U:\dev\openocean\branches\openoceanmap\oom_norcal_charter\Images\OCEAN_VERT_INNO.bmp"
        print >> ofi, r"WizardSmallImageFile=U:\dev\openocean\branches\openoceanmap\oom_norcal_charter\Images\OCEAN_SMALL_INNO.bmp"
        print >> ofi, r"SetupIconFile=U:\dev\openocean\branches\openoceanmap\oom_norcal_charter\Images\OCEAN_SMALL_INNO.ico"
        print >> ofi
...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("OpenOceanMap MLPA NC CPFV",
                            lib_dir,
                            dist_dir,
