...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("OpenOceanMap NOORC Charter",
                            lib_dir,
                            dist_dir,
