...
class Ui_SelectFishery(object):
    def setupUi(self, SelectFishery):
        ...
        self.fishery_comboBox.setMinimumSize(QtCore.QSize(400, 0))
        self.fishery_comboBox.setMaximumSize(QtCore.QSize(400, 16777215))
    ...
    def retranslateUi(self, SelectFishery):
        ...
        self.fishery_comboBox.setItemText(1, QtGui.QApplication.translate("SelectFishery", "Deeper nearshore fishery - hook and line (pre RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(2, QtGui.QApplication.translate("SelectFishery", "Deeper nearshore fishery - hook and line (post RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(3, QtGui.QApplication.translate("SelectFishery", "Deeper nearshore fishery - hook and line (cumulative)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(4, QtGui.QApplication.translate("SelectFishery", "Deeper nearshore fishery - longline (pre RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(5, QtGui.QApplication.translate("SelectFishery", "Deeper nearshore fishery - longline (post RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(6, QtGui.QApplication.translate("SelectFishery", "Deeper nearshore fishery - longline (cumulative)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(7, QtGui.QApplication.translate("SelectFishery", "Dungeness Crab - trap", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(8, QtGui.QApplication.translate("SelectFishery", "Hagfish - trap", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(9, QtGui.QApplication.translate("SelectFishery", "Herring - gillnet", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(10, QtGui.QApplication.translate("SelectFishery", "Lingcod -longline", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(11, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - hook and line (pre RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(12, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - hook and line (post RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(13, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - hook and line (cumulative)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(14, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - longline (pre RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(15, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - longline (post RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(16, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - longline (cumulative)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(17, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - trap (pre RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(18, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - trap (post RCA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(19, QtGui.QApplication.translate("SelectFishery", "Nearshore fishery - trap (cumulative)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(20, QtGui.QApplication.translate("SelectFishery", "Sablefish - longline", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(21, QtGui.QApplication.translate("SelectFishery", "Sablefish - trap", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(22, QtGui.QApplication.translate("SelectFishery", "Salmon - troll", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fishery_comboBox.setItemText(24, QtGui.QApplication.translate("SelectFishery", "Smelt - dip net or brail", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(25, QtGui.QApplication.translate("SelectFishery", "Surfperch - longline", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(26, QtGui.QApplication.translate("SelectFishery", "Urchin - diving", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_10.setText(QtGui.QApplication.translate("SelectFishery", "Num traps/hooks used per trip:", None, QtGui.QApplication.UnicodeUTF8))
