...
#
# Created: Thu Sep 24 15:34:20 2009
...
class Ui_InterviewStart(object):
    def setupUi(self, InterviewStart):
        ...
        self.fisherman_license_id_text = QtGui.QLabel(self.home_port_3)
        self.fisherman_license_id_text.setMinimumSize(QtCore.QSize(150, 0))
        self.fisherman_license_id_text.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.fisherman_license_id_text.setFont(font)
        self.fisherman_license_id_text.setObjectName("fisherman_license_id_text")
        self._5.addWidget(self.fisherman_license_id_text)
        self.fisherman_license_id_line = QtGui.QLineEdit(self.home_port_3)
        self.fisherman_license_id_line.setEnabled(True)
        self.fisherman_license_id_line.setMinimumSize(QtCore.QSize(200, 0))
        self.fisherman_license_id_line.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.fisherman_license_id_line.setFont(font)
        self.fisherman_license_id_line.setObjectName("fisherman_license_id_line")
        self._5.addWidget(self.fisherman_license_id_line)
        ...
        self._6 = QtGui.QHBoxLayout(self.vessel_length_4)
        ...
        self._6.addWidget(self.vessel_length_text_2)
        self.vessel_name_line = QtGui.QLineEdit(self.vessel_length_4)
    ...
    def retranslateUi(self, InterviewStart):
        ...
        self.fisherman_license_id_text.setText(QtGui.QApplication.translate("InterviewStart", "Fisherman License ID:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.state_vessel_id_text.setText(QtGui.QApplication.translate("InterviewStart", "Dept F&G Boat Number:", None, QtGui.QApplication.UnicodeUTF8))
        self.vessel_length_text_2.setText(QtGui.QApplication.translate("InterviewStart", "Vessel name :", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.haul_capacity_text.setText(QtGui.QApplication.translate("InterviewStart", "Haul Capacity (lb):", None, QtGui.QApplication.UnicodeUTF8))
