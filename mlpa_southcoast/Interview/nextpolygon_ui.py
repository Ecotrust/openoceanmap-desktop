...
#
# Created: Sat Jun 21 19:36:09 2008
...
class Ui_NextPolygon(object):
    def setupUi(self, NextPolygon):
        ...
        self.label_1.setMinimumSize(QtCore.QSize(90,0))
        self.label_1.setMaximumSize(QtCore.QSize(90,16777215))
        font = QtGui.QFont()
        ...
        self.line_1.setMaximumSize(QtCore.QSize(60,16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label = QtGui.QLabel(NextPolygon)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.pennies_left_label = QtGui.QLabel(NextPolygon)
        self.pennies_left_label.setMinimumSize(QtCore.QSize(40,0))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pennies_left_label.setFont(font)
        self.pennies_left_label.setObjectName("pennies_left_label")
        self.horizontalLayout_2.addWidget(self.pennies_left_label)
        ...
        self.habitat_combo_label.setMinimumSize(QtCore.QSize(90,0))
        self.habitat_combo_label.setMaximumSize(QtCore.QSize(90,16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, NextPolygon):
        ...
        self.label.setText(QtGui.QApplication.translate("NextPolygon", "Pennies Left:", None, QtGui.QApplication.UnicodeUTF8))
