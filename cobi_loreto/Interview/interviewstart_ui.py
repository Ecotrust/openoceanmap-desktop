...
#
# Created: Fri Jun 27 15:32:46 2008
...
class Ui_InterviewStart(object):
    def setupUi(self, InterviewStart):
        ...
        InterviewStart.resize(QtCore.QSize(QtCore.QRect(0,0,747,453).size()).expandedTo(InterviewStart.minimumSizeHint()))
        ...
        self.vboxlayout = QtGui.QVBoxLayout(self.interviewee)
        ...
        self.vboxlayout.addWidget(self.interviewee_first_name)
        ...
        self.vboxlayout.addWidget(self.interviewee_last_name)
        ...
        self.vboxlayout.addWidget(self.age)

        self.age_2 = QtGui.QWidget(self.interviewee)
        self.age_2.setObjectName("age_2")

        self.hboxlayout3 = QtGui.QHBoxLayout(self.age_2)
        ...
        self.hboxlayout3.addWidget(self.city_text)
        ...
        self.hboxlayout3.addWidget(self.city_line)
        self.vboxlayout.addWidget(self.age_2)
        ...
        self.hboxlayout4.addWidget(self.years_text)
        ...
        self.hboxlayout4.addWidget(self.years_spinBox)
        self.vboxlayout.addWidget(self.gender)
        self.gridlayout.addWidget(self.interviewee,0,0,1,1)
        ...
        self.gridlayout1.addWidget(self.home_port_2,0,0,1,1)
        ...
        self.gridlayout1.addWidget(self.home_port_3,1,0,1,1)
        ...
        self.hboxlayout5.addWidget(self.private_fish_text)
        ...
        self.hboxlayout5.addWidget(self.private_fish_line)
        self.gridlayout1.addWidget(self.ves_license,2,0,1,1)
        ...
        self.hboxlayout6 = QtGui.QHBoxLayout(self.ves_license_2)
        ...
        self.hboxlayout6.addWidget(self.ecotourism_text)
        ...
        self.hboxlayout6.addWidget(self.ecotourism_line)
        self.gridlayout1.addWidget(self.ves_license_2,3,0,1,1)
        ...
        self.hboxlayout7 = QtGui.QHBoxLayout(self.vessel_length)
        ...
        self.hboxlayout7.addWidget(self.cons_science_text)
        ...
        self.hboxlayout7.addWidget(self.cons_science_line)
        self.gridlayout1.addWidget(self.vessel_length,4,0,1,1)
        ...
        self.hboxlayout8 = QtGui.QHBoxLayout(self.vessel_length_2)
        ...
        self.hboxlayout8.addWidget(self.other_text)
        ...
        self.hboxlayout8.addWidget(self.other_line)
        self.gridlayout1.addWidget(self.vessel_length_2,5,0,1,1)
        self.gridlayout.addWidget(self.user_group_info,0,1,2,1)
        ...
        self.vboxlayout1 = QtGui.QVBoxLayout(self.interviewee_2)
        ...
        self.hboxlayout9 = QtGui.QHBoxLayout(self.interviewee_first_name_2)
        ...
        self.hboxlayout9.addWidget(self.date_text)
        ...
        self.hboxlayout9.addWidget(self.date_line)
        self.vboxlayout1.addWidget(self.interviewee_first_name_2)
        ...
        self.hboxlayout10 = QtGui.QHBoxLayout(self.interviewee_first_name_3)
        ...
        self.hboxlayout10.addWidget(self.interviewer_first_name_text)
        ...
        self.hboxlayout10.addWidget(self.interviewer_first_name_line)
        self.vboxlayout1.addWidget(self.interviewee_first_name_3)
        ...
        self.hboxlayout11 = QtGui.QHBoxLayout(self.interviewee_first_name_4)
        ...
        self.hboxlayout11.addWidget(self.interviewer_last_name_text)
        ...
        self.hboxlayout11.addWidget(self.interviewer_last_name_line)
        self.vboxlayout1.addWidget(self.interviewee_first_name_4)
        self.gridlayout.addWidget(self.interviewee_2,1,0,2,1)
        ...
        self.hboxlayout12 = QtGui.QHBoxLayout(self.button_box)
        ...
        self.hboxlayout12.addWidget(self.pbnCancel)
        ...
        self.hboxlayout12.addWidget(self.pbnNextWindow)
    ...
    def retranslateUi(self, InterviewStart):
        ...
        self.other_line.setText(QtGui.QApplication.translate("InterviewStart", "100", None, QtGui.QApplication.UnicodeUTF8))
