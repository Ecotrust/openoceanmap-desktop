...
#
# Created: Thu Jul 17 11:21:09 2008
...
class Ui_InterviewStart(object):
    def setupUi(self, InterviewStart):
        ...
        self.vboxlayout1 = QtGui.QVBoxLayout(self.interviewee)
        ...
        self.vboxlayout1.addWidget(self.interviewee_first_name)
        ...
        self.vboxlayout1.addWidget(self.interviewee_last_name)
        ...
        self.vboxlayout1.addWidget(self.age)

        self.age_2 = QtGui.QWidget(self.interviewee)
        self.age_2.setObjectName("age_2")

        self.hboxlayout4 = QtGui.QHBoxLayout(self.age_2)
        ...
        self.hboxlayout4.addWidget(self.city_text)
        ...
        self.hboxlayout4.addWidget(self.city_line)
        self.vboxlayout1.addWidget(self.age_2)

        self.gender = QtGui.QWidget(self.interviewee)
        self.gender.setObjectName("gender")

        self.hboxlayout5 = QtGui.QHBoxLayout(self.gender)
        self.hboxlayout5.setObjectName("hboxlayout5")

        self.gender_text = QtGui.QLabel(self.gender)
        self.gender_text.setMinimumSize(QtCore.QSize(45,0))
        self.gender_text.setMaximumSize(QtCore.QSize(60,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.gender_text.setFont(font)
        self.gender_text.setObjectName("gender_text")
        self.hboxlayout5.addWidget(self.gender_text)
        ...
        self.hboxlayout5.addWidget(self.gender_comboBox)

        self.years_text = QtGui.QLabel(self.gender)
        self.years_text.setMinimumSize(QtCore.QSize(100,0))
        ...
        self.hboxlayout5.addWidget(self.years_text)

        self.years_spinBox = QtGui.QSpinBox(self.gender)
        ...
        self.years_spinBox.setMaximumSize(QtCore.QSize(70,200))
        self.years_spinBox.setObjectName("years_spinBox")
        self.hboxlayout5.addWidget(self.years_spinBox)
        self.vboxlayout1.addWidget(self.gender)
        self.vboxlayout.addWidget(self.interviewee)
        ...
        self.vboxlayout2 = QtGui.QVBoxLayout(self.interviewee_2)
        ...
        self.hboxlayout7.addWidget(self.interviewer_first_name_text)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.interviewer_first_name_line.setFont(font)
        self.interviewer_first_name_line.setObjectName("interviewer_first_name_line")
        self.hboxlayout7.addWidget(self.interviewer_first_name_line)
        self.vboxlayout2.addWidget(self.interviewee_first_name_3)
        ...
        self.hboxlayout8.addWidget(self.interviewer_last_name_text)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.interviewer_last_name_line.setFont(font)
        self.interviewer_last_name_line.setObjectName("interviewer_last_name_line")
        self.hboxlayout8.addWidget(self.interviewer_last_name_line)
        self.vboxlayout2.addWidget(self.interviewee_first_name_4)
        self.vboxlayout.addWidget(self.interviewee_2)
        ...
        self.gridlayout = QtGui.QGridLayout(self.user_group_info)
        ...
        self.gridlayout1 = QtGui.QGridLayout(self.home_port_2)
        self.gridlayout1.setObjectName("gridlayout1")

        self.comm_fish_text = QtGui.QLabel(self.home_port_2)
        self.comm_fish_text.setMinimumSize(QtCore.QSize(250,0))
        ...
        self.gridlayout1.addWidget(self.comm_fish_text,0,0,1,1)

        self.comm_fish_line = QtGui.QLineEdit(self.home_port_2)
        self.comm_fish_line.setEnabled(True)
        self.comm_fish_line.setMinimumSize(QtCore.QSize(50,0))
        self.comm_fish_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.comm_fish_line.setFont(font)
        self.comm_fish_line.setObjectName("comm_fish_line")
        self.gridlayout1.addWidget(self.comm_fish_line,0,1,1,1)
        self.gridlayout.addWidget(self.home_port_2,1,0,1,1)
        ...
        self.gridlayout2 = QtGui.QGridLayout(self.home_port_3)
        self.gridlayout2.setObjectName("gridlayout2")

        self.comm_sport_text = QtGui.QLabel(self.home_port_3)
        self.comm_sport_text.setMinimumSize(QtCore.QSize(250,0))
        ...
        self.gridlayout2.addWidget(self.comm_sport_text,0,0,1,1)

        self.comm_sport_line = QtGui.QLineEdit(self.home_port_3)
        self.comm_sport_line.setEnabled(True)
        self.comm_sport_line.setMinimumSize(QtCore.QSize(50,0))
        self.comm_sport_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.comm_sport_line.setFont(font)
        self.comm_sport_line.setObjectName("comm_sport_line")
        self.gridlayout2.addWidget(self.comm_sport_line,0,1,1,1)
        self.gridlayout.addWidget(self.home_port_3,2,0,1,1)
        ...
        self.hboxlayout9 = QtGui.QHBoxLayout(self.ves_license)
        self.hboxlayout9.setObjectName("hboxlayout9")

        self.private_fish_text = QtGui.QLabel(self.ves_license)
        self.private_fish_text.setMinimumSize(QtCore.QSize(250,0))
        ...
        self.hboxlayout9.addWidget(self.private_fish_text)

        self.private_fish_line = QtGui.QLineEdit(self.ves_license)
        self.private_fish_line.setEnabled(True)
        self.private_fish_line.setMinimumSize(QtCore.QSize(50,0))
        self.private_fish_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.private_fish_line.setFont(font)
        self.private_fish_line.setObjectName("private_fish_line")
        self.hboxlayout9.addWidget(self.private_fish_line)
        self.gridlayout.addWidget(self.ves_license,3,0,1,1)
        ...
        self.hboxlayout10 = QtGui.QHBoxLayout(self.ves_license_2)
        self.hboxlayout10.setObjectName("hboxlayout10")

        self.ecotourism_text = QtGui.QLabel(self.ves_license_2)
        self.ecotourism_text.setMinimumSize(QtCore.QSize(250,0))
        ...
        self.hboxlayout10.addWidget(self.ecotourism_text)

        self.ecotourism_line = QtGui.QLineEdit(self.ves_license_2)
        self.ecotourism_line.setEnabled(True)
        self.ecotourism_line.setMinimumSize(QtCore.QSize(50,0))
        self.ecotourism_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.ecotourism_line.setFont(font)
        self.ecotourism_line.setObjectName("ecotourism_line")
        self.hboxlayout10.addWidget(self.ecotourism_line)
        self.gridlayout.addWidget(self.ves_license_2,4,0,1,1)
        ...
        self.hboxlayout11 = QtGui.QHBoxLayout(self.vessel_length)
        self.hboxlayout11.setObjectName("hboxlayout11")

        self.cons_science_text = QtGui.QLabel(self.vessel_length)
        self.cons_science_text.setMinimumSize(QtCore.QSize(250,0))
        ...
        self.hboxlayout11.addWidget(self.cons_science_text)

        self.cons_science_line = QtGui.QLineEdit(self.vessel_length)
        self.cons_science_line.setEnabled(True)
        self.cons_science_line.setMinimumSize(QtCore.QSize(50,0))
        self.cons_science_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.cons_science_line.setFont(font)
        self.cons_science_line.setObjectName("cons_science_line")
        self.hboxlayout11.addWidget(self.cons_science_line)
        self.gridlayout.addWidget(self.vessel_length,5,0,1,1)
        ...
        self.hboxlayout12 = QtGui.QHBoxLayout(self.vessel_length_2)
        self.hboxlayout12.setObjectName("hboxlayout12")

        self.other_text = QtGui.QLabel(self.vessel_length_2)
        self.other_text.setMinimumSize(QtCore.QSize(250,0))
        ...
        self.hboxlayout12.addWidget(self.other_text)
        ...
        self.other_line.setMaximumSize(QtCore.QSize(50,16777215))

        font = QtGui.QFont()
        font.setPointSize(10)
        self.other_line.setFont(font)
        self.other_line.setObjectName("other_line")
        self.hboxlayout12.addWidget(self.other_line)
        self.gridlayout.addWidget(self.vessel_length_2,6,0,1,1)

        self.label = QtGui.QLabel(self.user_group_info)
        ...
        self.vboxlayout4.addWidget(self.button_box)
        self.hboxlayout13.addLayout(self.vboxlayout4)
    ...
    def retranslateUi(self, InterviewStart):
        ...
        self.years_text.setText(QtGui.QApplication.translate("InterviewStart", "Years working here:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.user_group_info.setTitle(QtGui.QApplication.translate("InterviewStart", "What percentage of income/interest/stake do you have from the following?", None, QtGui.QApplication.UnicodeUTF8))
