...
#
# Created: Thu Jun 26 01:23:55 2008
...
class Ui_Other(object):
    def setupUi(self, Other):
        ...
        Other.resize(QtCore.QSize(QtCore.QRect(0,0,419,269).size()).expandedTo(Other.minimumSizeHint()))
        ...
        self.vessel_info = QtGui.QGroupBox(Other)
        ...
        self.button_box = QtGui.QWidget(Other)
        ...
        self.pbnSelectOther = QtGui.QPushButton(self.button_box)

        font = QtGui.QFont()
        font.setPointSize(10)
        self.pbnSelectOther.setFont(font)
        self.pbnSelectOther.setObjectName("pbnSelectOther")
        self.hboxlayout5.addWidget(self.pbnSelectOther)
    ...
    def retranslateUi(self, Other):
        Other.setWindowTitle(QtGui.QApplication.translate("Other", "OpenOceanMap - Interview", None, QtGui.QApplication.UnicodeUTF8))
        self.vessel_info.setTitle(QtGui.QApplication.translate("Other", "Other Income", None, QtGui.QApplication.UnicodeUTF8))
        self.employee_text.setText(QtGui.QApplication.translate("Other", "Type of Income:", None, QtGui.QApplication.UnicodeUTF8))
        self.specialist_comboBox.addItem(QtGui.QApplication.translate("Other", "Environmental Science", None, QtGui.QApplication.UnicodeUTF8))
        self.specialist_comboBox.addItem(QtGui.QApplication.translate("Other", "Social Science", None, QtGui.QApplication.UnicodeUTF8))
        self.specialist_comboBox.addItem(QtGui.QApplication.translate("Other", "Non-Governmental Organization", None, QtGui.QApplication.UnicodeUTF8))
        self.specialist_comboBox.addItem(QtGui.QApplication.translate("Other", "Government Agency", None, QtGui.QApplication.UnicodeUTF8))
        self.specialist_comboBox.addItem(QtGui.QApplication.translate("Other", "Other", None, QtGui.QApplication.UnicodeUTF8))
        self.vessel_length_text.setText(QtGui.QApplication.translate("Other", "other info1", None, QtGui.QApplication.UnicodeUTF8))
        self.vessel_motor_text.setText(QtGui.QApplication.translate("Other", "other info2", None, QtGui.QApplication.UnicodeUTF8))
        self.haul_capacity_text.setText(QtGui.QApplication.translate("Other", "other info3", None, QtGui.QApplication.UnicodeUTF8))
        self.pbnCancel.setText(QtGui.QApplication.translate("Other", "Cancel", None, QtGui.QApplication.UnicodeUTF8))
        self.pbnSelectOther.setText(QtGui.QApplication.translate("Other", "Draw Other Income Shapes", None, QtGui.QApplication.UnicodeUTF8))
