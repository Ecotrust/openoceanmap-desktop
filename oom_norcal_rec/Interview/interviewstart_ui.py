...
#
# Created: Mon Mar 09 14:40:07 2009
...
class Ui_InterviewStart(object):
    def setupUi(self, InterviewStart):
        ...
        self.hboxlayout4.addWidget(self.yrs_operating_text)
        ...
        self.hboxlayout4.addWidget(self.yrs_operating_line)
    ...
    def retranslateUi(self, InterviewStart):
        ...
        self.vessel_info.setTitle(QtGui.QApplication.translate("InterviewStart", "Sport Boat Fishing Information", None, QtGui.QApplication.UnicodeUTF8))
        self.perc_income_text.setText(QtGui.QApplication.translate("InterviewStart", "Type of sport boat:", None, QtGui.QApplication.UnicodeUTF8))
        self.boat_license_text.setText(QtGui.QApplication.translate("InterviewStart", "Boat License:", None, QtGui.QApplication.UnicodeUTF8))
        self.yrs_operating_text.setText(QtGui.QApplication.translate("InterviewStart", "Yrs operating sport boat:", None, QtGui.QApplication.UnicodeUTF8))
        self.yrs_owning_text.setText(QtGui.QApplication.translate("InterviewStart", "Yrs owning sport boat:", None, QtGui.QApplication.UnicodeUTF8))
        self.vessel_length_text.setText(QtGui.QApplication.translate("InterviewStart", "Vessel length (feet) :", None, QtGui.QApplication.UnicodeUTF8))
        self.storage_loc_text.setText(QtGui.QApplication.translate("InterviewStart", "Storage location:", None, QtGui.QApplication.UnicodeUTF8))
        self.home_port_text.setText(QtGui.QApplication.translate("InterviewStart", "Home Port:", None, QtGui.QApplication.UnicodeUTF8))
        self.landing_port_text.setText(QtGui.QApplication.translate("InterviewStart", "Launching Port 1:", None, QtGui.QApplication.UnicodeUTF8))
        self.landing_port_text_2.setText(QtGui.QApplication.translate("InterviewStart", "Launching Port 2:", None, QtGui.QApplication.UnicodeUTF8))
        self.landing_port_text_3.setText(QtGui.QApplication.translate("InterviewStart", "Launching Port 3:", None, QtGui.QApplication.UnicodeUTF8))
        self.landing_port_text_4.setText(QtGui.QApplication.translate("InterviewStart", "Launching Port 4:", None, QtGui.QApplication.UnicodeUTF8))
        self.years_text.setText(QtGui.QApplication.translate("InterviewStart", "Years experience fishing from sport boat:", None, QtGui.QApplication.UnicodeUTF8))
        self.avg_people_text.setText(QtGui.QApplication.translate("InterviewStart", "Avg # individuals on boat per trip:", None, QtGui.QApplication.UnicodeUTF8))
        self.avg_days_per_year_text.setText(QtGui.QApplication.translate("InterviewStart", "Avg # days fishing from boat per year:", None, QtGui.QApplication.UnicodeUTF8))
