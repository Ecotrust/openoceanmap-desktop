...
class Ui_SelectFishery(object):
    def setupUi(self, SelectFishery):
        ...
        self.label_6.setMaximumSize(QtCore.QSize(350, 16777215))
        ...
        SelectFishery.setTabOrder(self.fish_port, self.pbnFisheryFinished)
        SelectFishery.setTabOrder(self.pbnFisheryFinished, self.pbnStartShapes)
