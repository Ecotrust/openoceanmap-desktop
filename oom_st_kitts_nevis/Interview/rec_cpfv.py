...
class RecCpfvGui(QDialog, Ui_RecCpfv):
    def __init__(self, parent):
        ...
        self.fish_pct_19.setText('0')
        self.fish_pct_20.setText('0')        
    ...
    def on_pbnFinished_released(self):
        ...
        if self.fish_pct_19.text() != '0':
            cpfv_fisheries.append(('bait_net',self.fish_pct_19.text()))
        if self.fish_pct_20.text() != '0':
            cpfv_fisheries.append(('bait_castn',self.fish_pct_20.text()))
        ...
        interviewInfo2.append(["cps_p",self.fish_pct_1.text()])
        interviewInfo2.append(["cphl_p",self.fish_pct_2.text()])
        interviewInfo2.append(["ophl_p",self.fish_pct_3.text()])
        interviewInfo2.append(["cdtrap_p",self.fish_pct_4.text()])
        interviewInfo2.append(["cdhnd_p",self.fish_pct_5.text()])
        interviewInfo2.append(["cdspr_p",self.fish_pct_6.text()])
        interviewInfo2.append(["cdgl_p",self.fish_pct_7.text()])
        interviewInfo2.append(["demt_p",self.fish_pct_8.text()])
        interviewInfo2.append(["demhl_p",self.fish_pct_9.text()])
        interviewInfo2.append(["lobt_p",self.fish_pct_10.text()])
        interviewInfo2.append(["lobd_p",self.fish_pct_11.text()])
        interviewInfo2.append(["lobf_p",self.fish_pct_12.text()])
        interviewInfo2.append(["cnchs_p",self.fish_pct_13.text()])
        interviewInfo2.append(["cnchf_p",self.fish_pct_14.text()])
        interviewInfo2.append(["shrkhl_p",self.fish_pct_15.text()])
        interviewInfo2.append(["shrkgl_p",self.fish_pct_16.text()])
        interviewInfo2.append(["sqdhl_p",self.fish_pct_17.text()])
        interviewInfo2.append(["trtn_p",self.fish_pct_18.text()])
        interviewInfo2.append(["bllyn_p",self.fish_pct_19.text()])
        interviewInfo2.append(["achsn_p",self.fish_pct_20.text()])
