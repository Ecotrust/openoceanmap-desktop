...
class Ui_RecCpfv(object):
    def setupUi(self, RecCpfv):
        ...
        spacerItem21 = QtGui.QSpacerItem(50, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        RecCpfv.setTabOrder(self.fish_pct_18, self.pbnFinished)
