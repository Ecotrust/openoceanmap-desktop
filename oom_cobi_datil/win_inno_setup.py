...
class InnoScript:
    ...
    def create(self, pathname="dist\\OpenOceanMap.iss"):
        ...
        print >> ofi, r"VersionInfoDescription=OpenOceanMap Isle Datil"
        print >> ofi, r"VersionInfoCopyright=Ecotrust"
        print >> ofi, r"AppCopyright=Ecotrust"
        print >> ofi, r"InfoAfterFile=C:\code\projects\oom\loreto\README.TXT"
        print >> ofi, r"LicenseFile=C:\code\projects\oom\loreto\LICENSE.TXT"
        print >> ofi, r"WizardImageBackColor=clBlack"
        print >> ofi, r"WizardImageFile=C:\code\projects\oom\loreto\Images\OCEAN_VERT_INNO.bmp"
        print >> ofi, r"WizardSmallImageFile=C:\code\projects\oom\loreto\Images\OCEAN_SMALL_INNO.bmp"
        print >> ofi, r"SetupIconFile=C:\code\projects\oom\loreto\Images\OCEAN_SMALL_INNO.ico"
        print >> ofi
...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("OpenOceanMap Isle Datil",
                            lib_dir,
                            dist_dir,
