...
class MainWindow(QMainWindow, Ui_MainWindow):
  ...
  def loadBaseDataLayers(self):
    ...
    rasterList = [["Data"+os.sep+"Loreto_base.tif",10000,5000000]]
    ...
    vectorList = [["Data"+os.sep+"Aprov_Susten.shp",self.study_area_str, 0,5000000],
                  ["Data"+os.sep+"Bathymetry.shp",self.bathymetry_str, 0,5000000],
                  ["Data"+os.sep+"Zona_Restringido.shp",self.restricted_zone_str, 0,5000000],
                  ["Data"+os.sep+"Zona_Proteccion.shp",self.protected_zone_str, 0,5000000],                                   
                  ["Data"+os.sep+"Zona_Proteccion_Points.shp",self.protected_point_str, 0,5000000],
                  ["Data"+os.sep+"Seamounts.shp",self.seamount_str, 0,5000000],
    ...
    for vectorSet in vectorList:
      ...
      elif vector == "Data"+os.sep+"Zona_Proteccion.shp":
      ...
      elif vector == "Data"+os.sep+"Bathymetry.shp":
      ...
      elif vector == "Data"+os.sep+"Reference_Points.shp":
        layer.renderer().symbols()[0].setPointSize(9)
        layer.renderer().symbols()[0].setFillColor(QColor(255,170,0))
