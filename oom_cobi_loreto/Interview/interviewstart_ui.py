...
#
# Created: Sat Apr 04 20:25:11 2009
...
class Ui_InterviewStart(object):
    def setupUi(self, InterviewStart):
        ...
        InterviewStart.resize(902, 472)
        self.horizontalLayout = QtGui.QHBoxLayout(InterviewStart)
        ...
        self.years_text.setMinimumSize(QtCore.QSize(80, 60))
        self.years_text.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.years_spinBox.setMaximumSize(QtCore.QSize(70, 25))
        ...
        self.interviewee_first_name_5 = QtGui.QWidget(self.interviewee)
        self.interviewee_first_name_5.setObjectName("interviewee_first_name_5")
        self._2 = QtGui.QHBoxLayout(self.interviewee_first_name_5)
        self._2.setSpacing(4)
        self._2.setMargin(4)
        self._2.setObjectName("_2")
        self.date_text_2 = QtGui.QLabel(self.interviewee_first_name_5)
        self.date_text_2.setMinimumSize(QtCore.QSize(180, 0))
        self.date_text_2.setMaximumSize(QtCore.QSize(180, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.date_text_2.setFont(font)
        self.date_text_2.setObjectName("date_text_2")
        self._2.addWidget(self.date_text_2)
        self.organization_line = QtGui.QLineEdit(self.interviewee_first_name_5)
        self.organization_line.setEnabled(True)
        self.organization_line.setMinimumSize(QtCore.QSize(150, 0))
        self.organization_line.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.organization_line.setFont(font)
        self.organization_line.setCursorPosition(0)
        self.organization_line.setObjectName("organization_line")
        self._2.addWidget(self.organization_line)
        self.vboxlayout1.addWidget(self.interviewee_first_name_5)
        ...
        self.hboxlayout5 = QtGui.QHBoxLayout(self.interviewee_first_name_2)
        ...
        self.hboxlayout5.addWidget(self.date_text)
        ...
        self.hboxlayout5.addWidget(self.date_line)
        ...
        self.hboxlayout6 = QtGui.QHBoxLayout(self.interviewee_first_name_3)
        ...
        self.hboxlayout6.addWidget(self.interviewer_first_name_text)
        ...
        self.hboxlayout6.addWidget(self.interviewer_first_name_line)
        ...
        self.hboxlayout7 = QtGui.QHBoxLayout(self.interviewee_first_name_4)
        ...
        self.hboxlayout7.addWidget(self.interviewer_last_name_text)
        ...
        self.hboxlayout7.addWidget(self.interviewer_last_name_line)
        ...
        self.hboxlayout8 = QtGui.QHBoxLayout(self.ves_license)
        ...
        self.hboxlayout8.addWidget(self.private_fish_text)
        ...
        self.hboxlayout8.addWidget(self.private_fish_line)
        ...
        self.hboxlayout9 = QtGui.QHBoxLayout(self.ves_license_2)
        ...
        self.hboxlayout9.addWidget(self.ecotourism_text)
        ...
        self.hboxlayout9.addWidget(self.ecotourism_line)
        ...
        self.hboxlayout10 = QtGui.QHBoxLayout(self.vessel_length)
        ...
        self.hboxlayout10.addWidget(self.cons_science_text)
        ...
        self.hboxlayout10.addWidget(self.cons_science_line)
        ...
        self.hboxlayout11 = QtGui.QHBoxLayout(self.vessel_length_2)
        ...
        self.hboxlayout11.addWidget(self.other_text)
        ...
        self.hboxlayout11.addWidget(self.other_line)
        ...
        self.hboxlayout12.addItem(spacerItem)
        ...
        self.hboxlayout13 = QtGui.QHBoxLayout(self.button_box)
        ...
        self.hboxlayout13.addWidget(self.pbnCancel)
        ...
        self.hboxlayout13.addWidget(self.pbnNextWindow)
        self.vboxlayout4.addWidget(self.button_box)
        self.hboxlayout12.addLayout(self.vboxlayout4)
        self.vboxlayout3.addLayout(self.hboxlayout12)
        self.horizontalLayout.addLayout(self.vboxlayout3)
    ...
    def retranslateUi(self, InterviewStart):
        ...
        self.date_text_2.setText(QtGui.QApplication.translate("InterviewStart", "Company/Organization/Group:", None, QtGui.QApplication.UnicodeUTF8))
