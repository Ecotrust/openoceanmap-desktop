...
#
# Created: Wed Apr 01 05:03:21 2009
...
class Ui_ConsScience(object):
    def setupUi(self, ConsScience):
        ...
        self.comboSpecialist = QtGui.QComboBox(self.home_port_5)
        self.comboSpecialist.setMaximumSize(QtCore.QSize(200, 16777215))
        self.comboSpecialist.setObjectName("comboSpecialist")
        self.comboSpecialist.addItem(QtCore.QString())
        self.comboSpecialist.setItemText(0, "")
        self.comboSpecialist.addItem(QtCore.QString())
        self.comboSpecialist.addItem(QtCore.QString())
        self.comboSpecialist.addItem(QtCore.QString())
        self.comboSpecialist.addItem(QtCore.QString())
        self.comboSpecialist.addItem(QtCore.QString())
        self.comboSpecialist.addItem(QtCore.QString())
        self.hboxlayout.addWidget(self.comboSpecialist)
        ...
        self.focus_migratory_label = QtGui.QLabel(self.groupBox)
        self.focus_migratory_label.setMinimumSize(QtCore.QSize(280, 0))
        self.focus_migratory_label.setMaximumSize(QtCore.QSize(280, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.focus_migratory_label.setFont(font)
        self.focus_migratory_label.setObjectName("focus_migratory_label")
        self._18.addWidget(self.focus_migratory_label)
        self.focus_migratory = QtGui.QLineEdit(self.groupBox)
        self.focus_migratory.setEnabled(True)
        self.focus_migratory.setMinimumSize(QtCore.QSize(30, 0))
        self.focus_migratory.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.pbnExitConStep = QtGui.QPushButton(self.button_box)
        self.pbnExitConStep.setObjectName("pbnExitConStep")
        self.hboxlayout2.addWidget(self.pbnExitConStep)
    ...
    def retranslateUi(self, ConsScience):
        ...
        self.comboSpecialist.setItemText(1, QtGui.QApplication.translate("ConsScience", "Academic", None, QtGui.QApplication.UnicodeUTF8))
        self.comboSpecialist.setItemText(2, QtGui.QApplication.translate("ConsScience", "Non-Governmental Organization", None, QtGui.QApplication.UnicodeUTF8))
        self.comboSpecialist.setItemText(3, QtGui.QApplication.translate("ConsScience", "Government (Municipal)", None, QtGui.QApplication.UnicodeUTF8))
        self.comboSpecialist.setItemText(4, QtGui.QApplication.translate("ConsScience", "Government (State)", None, QtGui.QApplication.UnicodeUTF8))
        self.comboSpecialist.setItemText(5, QtGui.QApplication.translate("ConsScience", "Government (Federal)", None, QtGui.QApplication.UnicodeUTF8))
        self.comboSpecialist.setItemText(6, QtGui.QApplication.translate("ConsScience", "Other", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.focus_migratory_label.setText(QtGui.QApplication.translate("ConsScience", "Migratory fish - tuna, swordfish, sailfish:", None, QtGui.QApplication.UnicodeUTF8))
        self.focus_migratory.setText(QtGui.QApplication.translate("ConsScience", "0", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pbnExitConStep.setText(QtGui.QApplication.translate("ConsScience", "Exit ConScience Step", None, QtGui.QApplication.UnicodeUTF8))
