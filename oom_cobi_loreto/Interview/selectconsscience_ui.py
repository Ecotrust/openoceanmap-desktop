...
#
# Created: Mon Mar 30 06:29:15 2009
...
class Ui_SelectConsScience(object):
    def setupUi(self, SelectConsScience):
        ...
        self.comboFocus = QtGui.QComboBox(self.widget)
        self.comboFocus.setMaximumSize(QtCore.QSize(450, 16777215))
        self.comboFocus.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.comboFocus.setSizeAdjustPolicy(QtGui.QComboBox.AdjustToContents)
        self.comboFocus.setObjectName("comboFocus")
        self.comboFocus.addItem(QtCore.QString())
        self.comboFocus.addItem(QtCore.QString())
        self.comboFocus.addItem(QtCore.QString())
        self.comboFocus.addItem(QtCore.QString())
        self.comboFocus.addItem(QtCore.QString())
        ...
        self.comboFocus.addItem(QtCore.QString())
        self.comboFocus.addItem(QtCore.QString())
        self.hboxlayout.addWidget(self.comboFocus)
    ...
    def retranslateUi(self, SelectConsScience):
        ...
        self.comboFocus.setItemText(0, QtGui.QApplication.translate("SelectConsScience", "Coastal reef ecosystem - fish and invertebrates", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(1, QtGui.QApplication.translate("SelectConsScience", "Deep sea reef ecosystem - fish and invertebrates", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(2, QtGui.QApplication.translate("SelectConsScience", "Soft bottom - sand-mud-etc", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(3, QtGui.QApplication.translate("SelectConsScience", "Small pelagics - sardines-anchovy-etc", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(4, QtGui.QApplication.translate("SelectConsScience", "Migratory fish - tuna-swordfish-sailfish-yellowtail-etc", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(5, QtGui.QApplication.translate("SelectConsScience", "Sea turtles", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(6, QtGui.QApplication.translate("SelectConsScience", "Sea lions", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(7, QtGui.QApplication.translate("SelectConsScience", "Dolphins or whales", None, QtGui.QApplication.UnicodeUTF8))
        self.comboFocus.setItemText(8, QtGui.QApplication.translate("SelectConsScience", "Other", None, QtGui.QApplication.UnicodeUTF8))
