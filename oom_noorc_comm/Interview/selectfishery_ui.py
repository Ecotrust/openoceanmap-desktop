...
#
# Created: Sun Nov 22 12:55:22 2009
...
class Ui_SelectFishery(object):
    ...
    def retranslateUi(self, SelectFishery):
        ...
        self.fishery_comboBox.setItemText(3, QtGui.QApplication.translate("SelectFishery", "Groundfish - Midwater Trawl Pre RCA", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(4, QtGui.QApplication.translate("SelectFishery", "Groundfish - Midwater Trawl Post RCA", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(5, QtGui.QApplication.translate("SelectFishery", "Groundfish - Bottom Trawl Pre RCA", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(6, QtGui.QApplication.translate("SelectFishery", "Groundfish - Bottom Trawl Post RCA", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(7, QtGui.QApplication.translate("SelectFishery", "Groundfish - Longline Pre RCA (LE)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(8, QtGui.QApplication.translate("SelectFishery", "Groundfish - Longline Post RCA (LE)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(9, QtGui.QApplication.translate("SelectFishery", "Groundfish - Hook and Line Pre RCA (LE)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(10, QtGui.QApplication.translate("SelectFishery", "Groundfish - Hook and Line Post RCA (LE)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(11, QtGui.QApplication.translate("SelectFishery", "Groundfish - Trap Pre RCA (LE)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(12, QtGui.QApplication.translate("SelectFishery", "Groundfish - Trap Post RCA (LE)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(13, QtGui.QApplication.translate("SelectFishery", "Groundfish - Longline Pre RCA (OA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(14, QtGui.QApplication.translate("SelectFishery", "Groundfish - Longline Post RCA (OA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(15, QtGui.QApplication.translate("SelectFishery", "Groundfish - Hook and Line Pre RCA (OA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(16, QtGui.QApplication.translate("SelectFishery", "Groundfish - Hook and Line Post RCA (OA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(17, QtGui.QApplication.translate("SelectFishery", "Groundfish - Trap Pre RCA (OA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(18, QtGui.QApplication.translate("SelectFishery", "Groundfish - Trap Post RCA (OA)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(19, QtGui.QApplication.translate("SelectFishery", "Hagfish – Trap", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(20, QtGui.QApplication.translate("SelectFishery", "Halibut – Longline", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(21, QtGui.QApplication.translate("SelectFishery", "Pink Shrimp – Trawl", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fishery_comboBox.setItemText(23, QtGui.QApplication.translate("SelectFishery", "Sardine - Net (Seine)", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(24, QtGui.QApplication.translate("SelectFishery", "Urchin - Dive", None, QtGui.QApplication.UnicodeUTF8))
        self.fishery_comboBox.setItemText(25, QtGui.QApplication.translate("SelectFishery", "Other", None, QtGui.QApplication.UnicodeUTF8))
